:root {
  ...
  --telekom-color-text-and-icon-primary-standard: #5300ff;
  --telekom-color-text-and-icon-primary-hovered: #4700d9;
  --telekom-color-text-and-icon-primary-pressed: #3a00b3;
  ...
  --telekom-color-primary-standard: #5300ff;
  --telekom-color-primary-hovered: #4700d9;
  --telekom-color-primary-pressed: #3a00b3;
...
[data-mode="dark"] {
  ...
  --telekom-color-text-and-icon-primary-standard: #5300ff;
  --telekom-color-text-and-icon-primary-hovered: #8f59ff;
  --telekom-color-text-and-icon-primary-pressed: #a980ff;
