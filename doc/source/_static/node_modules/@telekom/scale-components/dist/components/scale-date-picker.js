...
import { d as defineCustomElement$6 } from './duet-date-picker2.js';
...
function defineCustomElement$1() {
  ...
  const components = ["scale-date-picker", "duet-date-picker", "scale-icon-content-calendar", "scale-icon-navigation-collapse-down", "scale-icon-navigation-left", "scale-icon-navigation-right"];
