...
const Chip = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  getIcon() {
    if (this.type === 'dynamic' && this.selected) {
      ...
      return (h("scale-icon-action-success", { "accessibility-title": "success", size: 16, selected: true }));
    }
    else if (this.type === 'persistent') {
      return (h("scale-icon-action-success", { "accessibility-title": "success", size: 16 }));
    }
  }
  render() {
...
function defineCustomElement$1() {
  ...
  const components = ["scale-chip", "scale-icon-action-close", "scale-icon-action-success"];
