...
function defineCustomElement$1() {
  ...
  const components = ["scale-notification-banner", "scale-icon-action-circle-close", "scale-icon-alert-error", "scale-icon-alert-information", "scale-icon-alert-success", "scale-icon-alert-warning", "scale-link"];
