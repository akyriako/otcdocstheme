...
const HTMLCell = {
  ...
  render: ({ content, component }) => {
    return (content && (index.h("scale-button", { variant: "secondary", size: "small", "icon-only": true, "aria-label": `Activate to ${content.isExpanded ? 'collapse' : 'expand'} content`, onClick: () => {
