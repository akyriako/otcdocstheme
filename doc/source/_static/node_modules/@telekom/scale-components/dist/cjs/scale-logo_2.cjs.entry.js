...
const Logo = class {
  ...
  render() {
    return (index.h(index.Host, { exportparts: "logo-svg" }, index.h("style", null, this.size ? `:host { --logo-size: ${this.size}px; }` : '', this.styles), index.h("a", { href: this.href, part: this.getCssClassMap(), tabIndex: this.focusable === false ? -1 : 0, onFocus: () => {
      ...
      }, title: this.logoHideTitle ? '' : this.logoTitle, "aria-describedby": this.logoAriaDescribedBy, "aria-hidden": this.logoAriaHidden, tabindex: this.logoAriaHidden ? -1 : 0 }, index.h("scale-logo-svg", { part: "icon", language: this.language, color: this.variant, logoTitle: this.logoTitle, logoHideTitle: this.logoHideTitle }))));
  }
  getCssClassMap() {
