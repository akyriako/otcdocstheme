...
export class LogoSvg {
  ...
  renderPaths() {
    switch (this.language) {
      case 'en':
        return (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 33 38", part: "logo-svg", fill: this.getColor(), role: this.innerRole === 'link' ? null : 'img', "aria-labelledby": `logo-title-${i}` },
