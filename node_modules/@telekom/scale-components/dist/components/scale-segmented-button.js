...
function defineCustomElement$1() {
  ...
  const components = ["scale-segmented-button", "scale-helper-text", "scale-icon-alert-error", "scale-icon-alert-information", "scale-icon-alert-success"];
