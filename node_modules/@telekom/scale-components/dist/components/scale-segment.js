...
const Segment = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    return (h(Host, null, this.styles && h("style", null, this.styles), h("button", { ref: (el) => (this.focusableElement = el), class: this.getCssClassMap(), id: this.segmentId, onClick: this.handleClick, disabled: this.disabled, type: "button", style: { width: this.width }, "aria-label": this.ariaLabelSegment, "aria-pressed": this.selected, part: this.getBasePartMap(), "aria-description": this.getAriaDescriptionTranslation() }, h("div", { class: "segment--mask" }, !this.iconOnly && (h("div", { class: "success-icon-container" }, h("scale-icon-action-success", { size: this.size === 'small' ? 14 : 16, class: "scale-icon-action-success", "aria-hidden": "true", selected: true }))), h("div", { class: "icon-container" }, h("slot", { name: "segment-icon" })), h("slot", null)))));
  }
  getBasePartMap() {
...
function defineCustomElement$1() {
  ...
  const components = ["scale-segment", "scale-icon-action-success"];
