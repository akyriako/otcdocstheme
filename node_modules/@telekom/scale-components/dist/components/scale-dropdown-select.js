...
import { d as defineCustomElement$7 } from './action-success.js';
import { d as defineCustomElement$6 } from './alert-error.js';
import { d as defineCustomElement$5 } from './alert-information.js';
import { d as defineCustomElement$4 } from './alert-success.js';
import { d as defineCustomElement$3 } from './navigation-collapse-down.js';
import { d as defineCustomElement$2 } from './navigation-collapse-up.js';
...
function defineCustomElement$1() {
  ...
  const components = ["scale-dropdown-select", "scale-helper-text", "scale-icon-action-success", "scale-icon-alert-error", "scale-icon-alert-information", "scale-icon-alert-success", "scale-icon-navigation-collapse-down", "scale-icon-navigation-collapse-up"];
...
const ScaleDropdownSelect = DropdownSelect;
const defineCustomElement = defineCustomElement$1;

export { ScaleDropdownSelect, defineCustomElement };
