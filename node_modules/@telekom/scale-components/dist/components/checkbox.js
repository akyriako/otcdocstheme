...
import { d as defineCustomElement$4 } from './action-indeterminate.js';
...
function defineCustomElement() {
  ...
  const components = ["scale-checkbox", "scale-icon-action-indeterminate", "scale-icon-action-success", "scale-icon-alert-error", "scale-icon-alert-information"];
