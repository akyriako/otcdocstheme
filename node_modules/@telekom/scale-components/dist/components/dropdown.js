...
import { d as defineCustomElement$2 } from './alert-success.js';
import { d as defineCustomElement$1 } from './navigation-collapse-down.js';
...
function defineCustomElement() {
  ...
  const components = ["scale-dropdown", "scale-helper-text", "scale-icon-alert-error", "scale-icon-alert-information", "scale-icon-alert-success", "scale-icon-navigation-collapse-down"];
