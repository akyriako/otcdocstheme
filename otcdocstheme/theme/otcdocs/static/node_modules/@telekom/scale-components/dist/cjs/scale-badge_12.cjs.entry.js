...
const utils = require('./utils-0145a0f3.js');
...
const TelekomNavItem$1 = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { part: index$1.classnames('base', this.animationState, this.variant, {
