...
const Chip = class {
  ...
  getIcon() {
    if (this.type === 'dynamic' && this.selected) {
      ...
      return (index.h("scale-icon-action-success", { "accessibility-title": "success", size: 16, selected: true }));
    }
    else if (this.type === 'persistent') {
      return (index.h("scale-icon-action-success", { "accessibility-title": "success", size: 16 }));
    }
  }
  render() {
