...
import { d as defineCustomElement$3 } from './alert-success.js';
...
function defineCustomElement$1() {
  ...
  const components = ["scale-notification-message", "scale-icon-action-circle-close", "scale-icon-alert-error", "scale-icon-alert-information", "scale-icon-alert-success", "scale-icon-alert-warning"];
