import{h as t,r as e,c as i,a as s,g as o}from"./p-d52b3602.js";import{c as l}from"./p-c608c6dc.js";import{e as a}from"./p-2a7c9d1b.js";const n={checkbox:{defaults:{sortBy:"number"},getLongestContent:({rows:t,columnIndex:e})=>t[0][e],render:({field:e,content:i,component:s,rowIndex:o,columnIndex:l})=>{const{style:a="checkbox",editable:n=!1,label:r}=e,d={checked:i,disabled:!n,label:r};switch(n&&(d.onScaleChange=t=>{const{value:e}=t.detail;s.rows[o][l]=e,s.triggerEditEvent(e,o,l)}),a){case"switch":return t("scale-switch",Object.assign({},d));default:return t("scale-checkbox",Object.assign({},d))}}},date:{defaults:{sortBy:"text"},render:({content:e,isAutoWidthCheck:i})=>{let s=e;return i&&(s=s.replace(/[0-9]/g,"8")),t("p",{class:"scl-body"},s)}},email:{defaults:{sortBy:"text"},render:({content:e})=>{const i=e.replace(/^mailto:/i,"");return t("scale-link",{href:e},i)}},graph:{defaults:{sortBy:"number"},render:({field:e,content:i})=>{const{style:s="progress",min:o=0,max:l=100}=e,a=(i-o)/(l-o)*100;switch(s){case"bar":return t("div",{class:"tbody__bar-cell"},t("scale-progress-bar",{"aria-hidden":"true",percentage:a,mute:!0,style:{maxWidth:"200px"},styles:".progress-bar__outer {\n                min-width: 50px;\n                max-width: 200px;\n              }\n              .progress-bar__inner {\n                background: var(--telekom-color-ui-faint) !important;\n              }\n              "}),t("p",{class:"scl-body"},i));default:return t("scale-progress-bar",{percentage:a,showStatus:!0,mute:!0,styles:".progress-bar__outer {\n              min-width: 50px;\n              max-width: 200px;\n            }\n            .progress-bar__inner {\n                background: var(--telekom-color-functional-informational-standard) !important;\n              }\n            "})}}},html:{defaults:{},getLongestContent:({rows:t,columnIndex:e})=>t[0][e],render:({content:e,component:i})=>e&&t("scale-button",{variant:"secondary",size:"small","icon-only":!0,"aria-label":`Activate to ${e.isExpanded?"collapse":"expand"} content`,onClick:()=>{e.isExpanded=!e.isExpanded,i.forceRender++}},t(e.isExpanded?"scale-icon-navigation-collapse-up":"scale-icon-navigation-collapse-down",{size:14}))},link:{defaults:{sortBy:"text"},render:({content:e})=>{const i=e.replace(/^https?\:\/\//i,"");return t("scale-link",{href:e,target:"_blank"},i)}},number:{defaults:{textAlign:"right",sortBy:"number"},render:({field:e,content:i,component:s,rowIndex:o,columnIndex:l,isAutoWidthCheck:a})=>{const{precision:n=1/0,decimalSymbol:r=".",groupSymbol:d="",prefix:c="",suffix:h="",editable:b=!1,label:p}=e;if(a&&b)return t("p",{class:"scl-body",style:{paddingRight:"26px"}},i);const g=`0.${(String(i).split(".")[1]||"").split("").map((()=>"0"))}`.replace(/,/g,"");if(b){const e={type:"number",size:"small",step:g.slice(0,g.length-1)+"1",value:String(i),styles:".text-field__control {\n          text-align: right !important;\n        }",label:p,onScaleChange:({detail:t})=>{const{value:e}=t;s.rows[o][l]=e,s.triggerEditEvent(e,o,l)}};return t("scale-text-field",Object.assign({},e))}{let e=i;if(a&&(e=Number(e.toString().replace(/[0-9]/g,"8"))),e=n<100?Number(e).toFixed(n):e.toString(),d||"."!==r){const t=e.split(".");d&&(t[0]=t[0].replace(/\B(?=(\d{3})+(?!\d))/g,d)),e=t.join(r)}return(c||h)&&(e=c+e+h),t("p",{class:"scl-body",style:{textAlign:"right"}},e)}}},select:{defaults:{sortBy:"text"},render:({field:e,content:i,component:s,rowIndex:o,columnIndex:l,isAutoWidthCheck:a})=>{const{options:n,editable:r=!1,label:d}=e;if(a)return t("p",{class:"scl-body",style:{paddingRight:"56px"}},i);const c={disabled:!r,value:i,label:d};return r&&(c.onScaleChange=({detail:t})=>{const{value:e}=t;s.rows[o][l]=e,s.triggerEditEvent(e,o,l)}),t("scale-dropdown",Object.assign({size:"small"},c),n.map((e=>t("option",{value:e,selected:e===i},e))))}},tags:{defaults:{sortBy:"text"},render:({content:e})=>{const i=e.split(",").map((t=>t.trim()));return t("ul",{class:"tbody__tag-list"},i.map((e=>t("li",null,t("scale-tag",{size:"small",type:"strong"},e)))))}},telephone:{defaults:{sortBy:"text"},render:({content:e})=>{const i=e.replace(/^tel:/i,"");return t("scale-link",{href:e},i)}},text:{defaults:{sortBy:"text"},render:({field:e,content:i,component:s,rowIndex:o,columnIndex:l,isAutoWidthCheck:a})=>{const{variant:n="body",editable:r=!1,iconPrefix:d,iconSuffix:c,label:h}=e;if(a&&r)return t("p",{class:"scl-body",style:{paddingRight:"26px"}},i);if(r){return t("scale-text-field",Object.assign({},{type:"text",value:i,label:h,onScaleChange:({detail:t})=>{const{value:e}=t;s.rows[o][l]=e,s.triggerEditEvent(e,o,l)}}))}{let e=i;return a&&(e+="w"),t("div",{class:"tbody__text-cell"},d&&t("span",{class:"tbody__text-cell-prefix"},t(`scale-icon-${d}`)),t("p",{class:`scl-${n}`},e),c&&t("span",{class:"tbody__text-cell-suffix"},t(`scale-icon-${c}`)))}}},actions:{defaults:{},render:({content:e})=>t("div",{class:"tbody__actions"},e.map((e=>{const{label:i}=e,s=function(t,e){var i={};for(var s in t)Object.prototype.hasOwnProperty.call(t,s)&&e.indexOf(s)<0&&(i[s]=t[s]);if(null!=t&&"function"==typeof Object.getOwnPropertySymbols){var o=0;for(s=Object.getOwnPropertySymbols(t);o<s.length;o++)e.indexOf(s[o])<0&&Object.prototype.propertyIsEnumerable.call(t,s[o])&&(i[s[o]]=t[s[o]])}return i}(e,["label"]);return"object"==typeof i&&"__html"in i?t("scale-button",Object.assign({innerHTML:i.__html},s)):t("scale-button",Object.assign({},s),i)})))}},r={maxWidth:1/0,minWidth:20,resizable:!0,sortable:!1,sortBy:"text",textAlign:"left",visible:!0,width:"auto"};
/**
 * @license
