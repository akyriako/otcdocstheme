    ...
    return (h(Host, null,
      ...
      h("div", { part: this.getBasePartMap(), class: this.getCssClassMap() },
        h("div", { class: "progress-bar__top-container" },
          ...
          !!this.showStatus && !this.hasError && this.percentage !== 100 && (h("div", { part: "status", class: "progress-bar__status", "aria-hidden": "true" },
            this.percentage,
            "%")),
          this.hasError ? (h("div", { class: "progress-bar__icon" },
            ...
            h("scale-icon-alert-success", { size: ICON_SIZE }))) : null),
