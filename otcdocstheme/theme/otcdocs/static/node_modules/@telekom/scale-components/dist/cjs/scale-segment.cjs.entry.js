...
const Segment = class {
  ...
  render() {
    return (index.h(index.Host, null, this.styles && index.h("style", null, this.styles), index.h("button", { ref: (el) => (this.focusableElement = el), class: this.getCssClassMap(), id: this.segmentId, onClick: this.handleClick, disabled: this.disabled, type: "button", style: { width: this.width }, "aria-label": this.ariaLabelSegment, "aria-pressed": this.selected, part: this.getBasePartMap(), "aria-description": this.getAriaDescriptionTranslation() }, index.h("div", { class: "segment--mask" }, !this.iconOnly && (index.h("div", { class: "success-icon-container" }, index.h("scale-icon-action-success", { size: this.size === 'small' ? 14 : 16, class: "scale-icon-action-success", "aria-hidden": "true", selected: true }))), index.h("div", { class: "icon-container" }, index.h("slot", { name: "segment-icon" })), index.h("slot", null)))));
  }
  getBasePartMap() {
